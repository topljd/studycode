...
# # tween 渐变函数
# #
# pyautogui.click(x=10, y=10, clicks=1, interval=0.0, button='left', duration=0.0, tween=pyautogui.linear)
# # 鼠标相对移动 ,向下移动
# #pyautogui.moveRel(None, 10)
# pyautogui.moveRel(xOffset=None, yOffset=100,duration=1, tween=pyautogui.linear)
# # 鼠标当前位置0间隔双击
